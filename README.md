...
- Інвентар та предмети (зараз кожен бачить свою копію впалого луту —
  дюпа при підбиранні, поки не закрита)
- Стан NPC
- Погода
...
- Синхронізація інвентаря та подій підбирання (закрити дюпу впалого луту через
  пакет 0x0C)
- Синхронізація NPC
